...
// Look for .env.local in frontend directory first, then project root
...
if (fs.existsSync(envPath)) {
  ...
  actualEnvPath = envPathRoot;
  require('dotenv').config({ path: envPathRoot });
} else {
  console.log('❌ .env.local file not found in frontend/ or project root!');
...
console.log(`✅ .env.local file found at: ${actualEnvPath}\n`);
